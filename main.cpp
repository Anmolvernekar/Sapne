...
void wish::menu()
{
    ...
    cout<<"\t\t\t Hey..! IS IT YOU'RE FIRST TIME? (Y/N):";
    cin>>ans;
    if(ans =='y' || ans =='Y')
    {
...
menustart:
    ...
    cout << "\n-----------------------------------------------------------------------------------------------------";
    cout<<endl;
    cout << "\t\t\t\t    ~ITS TIME TO FOLLOW YOU'RE DREAMS~" << endl;
    cout<<endl;
    cout << "\t Hey "+ myname +"! \"Make a bucket list and fill it with dreams that have no boundaries.\" " << endl;
    cout<<endl;

    cout << "\t\t\t\t 1. Enter Your GOAL" << endl;
    cout << "\t\t\t\t 2. Display your GOAL[list]" << endl;
    cout << "\t\t\t\t 3. Modify  your GOAL" << endl;
    cout << "\t\t\t\t 4. Search your GOAL" << endl;
    cout << "\t\t\t\t 5. Delete  your GOAL" << endl;
    cout << "\t\t\t\t 6. GIVE UP ON DREAMS" << endl;
...
void wish::insert()
{
    ...
    cout << "\t\t\t\tEnter Goal No: ";
    cin >> goalno;
    cout << "\t\t\t\tEnter Goal Name(Ex:Kedarnath): ";
    cin >> name;
    cout << "\t\t\t\tEnter Goal Description(How you want to achieve it): ";
    cin >> description;
    cout << "\t\t\t\tEnter Category(Hiking,fun etc): ";
    cin >> category;
